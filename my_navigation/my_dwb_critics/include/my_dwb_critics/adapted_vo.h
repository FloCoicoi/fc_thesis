...
#ifndef MY_DWB_CRITICS_ADAPTED_VO_H_
#define MY_DWB_CRITICS_ADAPTED_VO_H_
 ...
 */
  class AdaptedVOCritic: public dwb_local_planner::TrajectoryCritic
  {
  public:
    ...
    double dist_decay_, tc_, time_scale_;
    int traj_step_;
...
#endif /* MY_DWB_CRITICS_ADAPTED_VO_H_ */
