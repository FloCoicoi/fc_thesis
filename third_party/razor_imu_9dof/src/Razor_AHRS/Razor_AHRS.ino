...
float ACCEL_X_MIN = -253.00;
float ACCEL_X_MAX = 258.00;
float ACCEL_Y_MIN = -254.00;
float ACCEL_Y_MAX = 260.00;
float ACCEL_Z_MIN = -270.00;
float ACCEL_Z_MAX = 247.00;

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
float MAGN_X_MIN = -243.0;
float MAGN_X_MAX = 927.0;
float MAGN_Y_MIN = -155.0;
float MAGN_Y_MAX = 920.0;
float MAGN_Z_MIN = -120.0;
float MAGN_Z_MAX = 779.0;
...
float magn_ellipsoid_center[3] = {256.783, 283.894, 353.880};
float magn_ellipsoid_transform[3][3] = {{0.893638, 0.0560081, 0.0590534}, {0.0560081, 0.885771, 0.0499611}, {0.0590534, 0.0499611, 0.889674}};
